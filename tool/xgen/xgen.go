...
import (
	...
	"github.com/mloves0824/rpcx/v5/tool/xgen/parser"
)
...
func generate(parsers []*parser.Parser) error {
	...
	fmt.Fprintln(w, `  "github.com/mloves0824/rpcx/v5/server"`)
	fmt.Fprintln(w, `  "github.com/mloves0824/rpcx/v5/serverplugin"`)
